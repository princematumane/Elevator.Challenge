...
class Program
{
    ...
    static async Task Main(string[] args)
    {
        ...
        var elevatorConfigSection = configuration.GetSection("ElevatorConfiguration");

        serviceCollection.Configure<ElevatorConfiguration>(elevatorConfigSection);

        var elevatorConfig = elevatorConfigSection.Get<ElevatorConfiguration>();
        var options = Options.Create(elevatorConfig);
        ...
        var building = new Building(elevatorDispatcher, logger, options);


        string[] floors = new string[elevatorConfig.TotalFloors];
